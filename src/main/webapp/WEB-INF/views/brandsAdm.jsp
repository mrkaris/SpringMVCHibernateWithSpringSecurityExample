    ...
    <body>
        <div class="uk-section uk-section-medium uk-section-muted ">
            <div class="uk-container uk-container-expand">
                ...
                <a class="uk-button uk-button-primary" href="<c:url value='/admin/brands/insert' />">Add New </a>
                <!--        <p> </p>-->
                    ...
                    <tbody>
                        <c:forEach items="${brands}" var="brand">
                            <tr>
                                ...
                                <td><a href="<c:url value='/edit/${brand.brandId}' />" class="uk-button uk-button-default 

                                       custom-width">edit</a></td>
                                <td><a href="<c:url value='/delete/${brand.brandId}' />" class="uk-button uk-button-danger	 
